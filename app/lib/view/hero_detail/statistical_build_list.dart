...
class StatisticalBuildList extends StatelessWidget {
  ...
  StatisticalBuildList(this.hero, this.playBuild, this.showTalentBottomSheet, this.statisticalBuilds, this.buildSort);
  ...
  Widget build(BuildContext context) {
    if (statisticalBuilds != null && statisticalBuilds.isNotEmpty) {
      ...
      return new ListView(
        ...
        children: builds.map((StatisticalHeroBuild b) => new BuildCard(b,  playBuild, hero, showTalentBottomSheet, type: b.label,)).toList()
      );
    }
