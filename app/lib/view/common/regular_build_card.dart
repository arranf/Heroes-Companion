...
class RegularBuildCard extends StatefulWidget {
  ...
  RegularBuildCard(this.regularBuild, this._onPressed, this.hero,
...
class _RegularBuildCardState extends State<RegularBuildCard> {
  ...
  Widget build(BuildContext context) {
    ...
    try {
      widget.regularBuild.talentTreeIds.forEach((talentTreeId) {
        Talent talent = widget.hero.talents
            .firstWhere((t) => t.talent_tree_id == talentTreeId);
        talents.add(talent);
      });
    } catch (e) {
      ...
      child: new Card(
        child: new Container(
          padding: new EdgeInsets.symmetric(horizontal: 8.0)
              .add(new EdgeInsets.only(top: 16.0, bottom: 8.0)),
          child: new Column(
            ...
            children: <Widget>[
              ...
              widget.regularBuild.tagline != null
                  ? new Text(
                      widget.regularBuild.tagline,
                      style: style.body1,
                      maxLines: 3,
                    )
                  : new Container(),
              ...
              new Row(
                  ...
                  children: talents
                      .map((Talent t) => isPhone
                          ? _buildPhoneTalent(context, t)
                          : _buildTabletTalent(context, t))
                      .toList()),
              new ButtonTheme.bar(
                child: new ButtonBar(
                  children: <Widget>[
                    ...
                    new FlatButton(
                      ...
                      onPressed: () => widget._onPressed(
                          context,
                          new HeroBuild(widget.hero.hero_id,
                              widget.regularBuild.talentTreeIds)),
                    ),
                    widget.regularBuild.description != null &&
                            widget.regularBuild.description != ''
                        ? new IconButton(
                            tooltip: 'Show Description',
                            icon: _isShowingDescription
