...
import 'package:heroes_companion/view/common/hero_grid.dart';
...
class HeroHome extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new StoreConnector<AppState, _ViewModel>(
      ...
      builder: (context, vm) {
        return new HeroGrid(vm.heroes, onTap: vm.onTap);
      },
    );
  }
}
...
class _ViewModel {
  ...
  final dynamic onTap = (BuildContext context, HeroGridItem heroListItem) {
