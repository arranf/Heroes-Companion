...
class Settings {
  ...
  Settings(this.currentUpdateOriginTime, this.nextRotationDate, this.updatePatch, this.dataSource, this.themeType);

  Settings copyWith({DateTime currentUpdateOriginTime, DateTime nextRotationDate, String updatePatch, DataSource dataSource, ThemeType themeType}) {
    return new Settings(
