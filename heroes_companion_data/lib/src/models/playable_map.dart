...
class PlayableMap {
  ...
  final String objective_start_time;
  final String objective_interval;
  ...
  factory PlayableMap.fromMap(Map map) {
    ...
    String objective_start_time = map[table.column_objective_start_time];
    String objective_interval = map[table.column_objective_interval];
