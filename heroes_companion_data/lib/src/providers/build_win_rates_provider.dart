...
class BuildWinRatesProvider {
  Future<api.BuildWinRates> getBuildWinRates(String buildNumber, String heroName) async {
    BuildWinRates buildWinRates = await api.getBuildWinRates(buildNumber, heroName);
